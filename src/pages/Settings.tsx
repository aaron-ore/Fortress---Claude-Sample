...
import { BUSINESS_MODES, BUSINESS_MODE_META } from "@/lib/businessModes";
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Business type — drives which features the whole app shows. */}
          <div className="space-y-2">
            ...
            >
              {BUSINESS_MODES.map((m) => {
                const meta = BUSINESS_MODE_META[m];
                const Icon = meta.icon;
                const selected = industry === m;
                return (
                  <Label
                    key={m}
                    htmlFor={`industry-${m}`}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <RadioGroupItem value={m} id={`industry-${m}`} />
                    </div>
            ...
            <p className="text-xs text-muted-foreground">
              Changes which features appear across the app — navigation, dashboard, and inventory fields — for everyone in your organization.
            </p>
          </div>
